		...
		limit ".$inicio.",20;
			...
			<table > 
				...
				<tr bgcolor="" class="hoverrow">
					...
					<td class="tdUpdate">
						<center><a href="#modal1" style="cursor: pointer" idprov="<?php echo $row['id_prov'];?>" onclick="actualizar(this)" ><img class="imgprov" src="../img/actualizar.png"></a></center>
					</td>
					<td>
						<center><a  style="cursor: pointer" idprov="<?php echo $row['id_prov'];?>" onclick="eliminar(this)" ><img class="imgprov" src="../img/eliminar.png"></a></center>
					</td>	
				</tr>
				<?php
					}//end if contador
